...
enum Update_States{column0, column1, column2, column3, column4, column5, column6, column7} update_state;
	
int update_column(int state)
{
	update_state = state;
		switch(update_state)
		{ 
			...
			case -1:
				...
				updateMatrix[0][0] = 1;
				updateBoard();
				update_state = column0;
			break;
			case column0:
				updateBoard();
				update_state = column1;
			break;
			case column1:
				update_state = column2;
			break;
			case column2:
				update_state = column3;
			break;
			case column3:
				update_state = column4;
			break;
			case column4:
				update_state = column5;
			break;		
			case column5:
				update_state = column6;
			break;
			case column6:
				update_state = column7;
			break;
			case column7:
					update_state = column7;
			break;
		...
		{ //Actions
			case column0:
				PORTD = 0x00;
				transmit_data_blue(~(MatrixRows[0]));
				PORTD = 0x01;
			break;
			case column1:
				//PORTD = 0x00;
				transmit_data_blue(~(MatrixRows[1]));
				PORTD = 0x02;
			break;
			case column2:
				//PORTD = 0x00;
				transmit_data_blue(~(MatrixRows[2]));
				PORTD = 0x04;
			break;
			case column3:
				//PORTD = 0x00;
				transmit_data_blue(~(MatrixRows[3]));
				PORTD = 0x08;
			break;
			case column4:
				//PORTD = 0x00;
				transmit_data_blue(~(MatrixRows[4]));
				PORTD = 0x10;
			break;
			case column5:
				//PORTD = 0x00;
				transmit_data_blue(~(MatrixRows[5]));
				PORTD = 0x20;
			break;
			case column6:
				//PORTD = 0x00;
				transmit_data_blue(~(MatrixRows[6]));
				PORTD = 0x40;
			break;
			case column7:
				//PORTD = 0x00;
				transmit_data_blue(~(MatrixRows[7]));
				PORTD = 0x80;
			break;
		}
	return update_state;
...
int main(void)
{
	...
	task3.TickFct = &update_column;//Function pointer for the tick.
